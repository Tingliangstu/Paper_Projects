...
% transversal 
subplot(1, 2, 1);
plot(w(2:end), Sq_T(2:end, q_1), 'o-', 'LineWidth', lw);
hold on;
plot(w(2:end), Sq_T(2:end, q_2), 'o-', 'LineWidth', lw);
...
% longitudinal part
subplot(1, 2, 2);
plot(w(2:end), Sq_L(2:end, q_1), 'o-', 'LineWidth', lw);
hold on;
plot(w(2:end), Sq_L(2:end, q_2), 'o-', 'LineWidth', lw);
