...
%% plot other WTE
h4 = loglog(Yang_2022_WTE_anharmonic(:, 1), Yang_2022_WTE_anharmonic(:, 2), 'p', 'MarkerSize', 13.0, 'linewidth', 2.0, 'Color', color_8);
hold on;
h5 = loglog(Michele_2022_rWTE_GAP(:, 1), Michele_2022_rWTE_GAP(:, 2), 'b-', 'linewidth', 2.5, 'Color', color_2);
hold on;
...
h7 = errorbar(Tem, kappa_quantum, error_quantum, 'o', 'MarkerSize', 13.0,...
...
%yticks(1:5:2);
h_legend = legend([h6, h7, h4, h5, h1, h3], 'This work (Classical $\kappa$)','This work (Quantum $\kappa^q$)', 'Yang $et$ $al.$ (Anharmonic WTE)', ...
    'Michele $et$ $al.$ (rWTE-GAP)', 'Cahill $et$ $al.$ (Expt.)', 'Wray $et$ $al.$ (Expt.)', 'location', 'best', 'NumColumns', 1, 'Box', 'off');
