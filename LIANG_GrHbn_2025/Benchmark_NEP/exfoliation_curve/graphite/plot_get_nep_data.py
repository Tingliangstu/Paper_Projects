...
structure = read('matrix_graphite_1x1x1_opti_frac.vasp')
...
DFT_data = loadtxt('result_ener_dist_exfoliation_curve.data')

# save nep-data

np.savetxt('Graphite.data', np.column_stack((DFT_data[:, 1], nep_energies)))
...
plot(DFT_data[:, 1], relative_nep_energies*1000, 'o', c="C4", label="NEP")
